...
metadata {
	...
	tiles {
        ...
        standardTile("button2", "device.switch2", width: 3, height: 3, canChangeIcon: false) {
			state "off", label: 'Light Off', action: "switch.on", icon: "st.Lighting.light11", backgroundColor: "#ffffff", nextState: "turning_on"
            state "turning_off", label: 'Turning Off', action: "switch.off", icon: "st.Lighting.light11", backgroundColor: "#ffffff", nextState: "off"
			state "on", label: 'Light On', action: "switch.off", icon: "st.Lighting.light11", backgroundColor: "#79b821", nextState: "turning_off"
            state "turning_on", label: 'Turning On', action: "switch.on", icon: "st.Lighting.light11", backgroundColor: "#79b821", nextState: "on"
		}
...
def result = new physicalgraph.device.HubAction(
			...
			sendEvent(name: "switch2", value: "turning_on")
...
def result = new physicalgraph.device.HubAction(
			...
			sendEvent(name: "switch2", value: "turning_off")        
